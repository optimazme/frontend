export const state = () => ({
  ...
  mazeImages: [],
  minutesLeft: 0,
  pfpSource: `${process.env.BASE_URL}/mazes/mysterious_dogs_for_better_lives.png`,
  prompt: [],
  mazeInfo: {},
  mazeObj: `${process.env.BASE_URL}/mazes/demo.glb`,
  mazeFloor: `${process.env.BASE_URL}/mazes/dog_floor.png`,
  showImages: [],
...
export const getters = {
  ...
  mazeFloor: state => state.mazeFloor,
