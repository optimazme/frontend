<template>
  <div>
    ...
    <div>
      <button @click="buyImage">buy thing?</button>
    </div>
...
const provider: any = process.browser ? new ethers.providers.Web3Provider(window.ethereum) : null

const seaport = process.browser ? new Seaport(provider) : ''
